    ...
    <div class="container" style="width: 100%; max-width: 1080px">
      ...
      <footer id="footer" class="bg-gray-secondary">
        <div class="container">
          ...
          >
            <div class="col-lg-5">
              ...
              <p>
                ...
                membagikan informasi mengenai produk yang dibuat serta
                menunjukkan keaslian produk yang dibuat dengan memberikan label
                QRCode untuk...
                <span
                  ><router-link
                    to="/tentangview"
            ...
            <div class="col-lg-3 py-3">
              <div class="d-flex gap-3">
                ...
                <div class="text-primary">
                  <p class="mb-0" style="color: #4e944f" href="#">
                    Punya Pertanyaan?
                  </p>
                  <a
                    href="#"
          ...
          <div
            class="footer-bar py-3 d-flex align-items-center justify-content-between flex-wrap"
          >
            <div class="col-md-8">
